    ...
    <form action="{{ url('admin/products/store') }}" enctype="multipart/form-data" method="POST">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3 mt-3">
                    <label for="name" class="form-label">Title Post:</label>
                    <input type="text" class="form-control" id="name" placeholder="Enter name" name="title_post">
                </div>
                <div class="mb-3 mt-3">
                    <label for="img_thumbnail" class="form-label">Img Title:</label>
