...
<form action="index.php?act=dangki" method="post">
    ...
    <input type="text" name="username" placeholder="Nhập tên đăng nhập của bạn.." required><br>
    </div>
  <div class="fdn2">
  <label >Password</label><br>
  <input type="password" name="password" placeholder="Nhập mật khẩu của bạn.." required><br>
  ...
  <input type="int" name="phone" placeholder="Nhập số điện thoại của bạn.." required><br>
